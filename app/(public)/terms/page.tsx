  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-24 text-fg">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
        ...
        <h2 className="font-serif text-2xl mt-10 mb-4">2. Intellectual Property</h2>
        ...
        <h2 className="font-serif text-2xl mt-10 mb-4">3. User Content</h2>
        <p>When submitting content through the contact form or newsletter signup, you grant us permission to store and process that information as described in our <a href="/privacy" className="text-brand hover:underline">Privacy Policy</a>.</p>

        <h2 className="font-serif text-2xl mt-10 mb-4">4. Blog Content</h2>
        ...
        <h2 className="font-serif text-2xl mt-10 mb-4">5. Services</h2>
        ...
        <h2 className="font-serif text-2xl mt-10 mb-4">7. Changes to Terms</h2>
        ...
        <h2 className="font-serif text-2xl mt-10 mb-4">8. Governing Law</h2>
        <p>These terms are governed by and construed in accordance with the laws of the Republic of Uganda.</p>

        <h2 className="font-serif text-2xl mt-10 mb-4">9. Contact</h2>
        <p>For questions about these terms, contact us at <a href="mailto:hello@bododesderio.com" className="text-brand hover:underline">hello@bododesderio.com</a>.</p>
      </div>
    </article>
  )
}
